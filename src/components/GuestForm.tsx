      ...
      <div className="flex-1 space-y-5 overflow-y-auto px-1 py-1">
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full px-6 py-3 text-7xl font-bold border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-blue-500/30 focus:border-blue-600 transition-all shadow-sm placeholder-gray-300"
            placeholder="이름 입력"
            autoComplete="off"
            autoCorrect="off"
            spellCheck={false}
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-3 text-7xl font-bold border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-blue-500/30 focus:border-blue-600 transition-all shadow-sm text-right pr-20 placeholder-gray-300"
              placeholder="0 (선택)"
              autoComplete="off"
            />
            <span className="absolute right-6 top-1/2 transform -translate-y-1/2 text-gray-400 text-2xl font-bold">
              원
            </span>
          </div>
          {/* 한국어 금액 표시 (고정 높이) */}
